class ApiEndpoints {
  ...
  static const String baseUrlForImage = "http://10.0.2.2:3000/";
  ...
  static const String updateProfilePicture =
      "$baseUrl/user/update-profile-picture";
  ...
  static String getLessonsByCourseId(String courseId) {
    return "$baseUrl/lesson/course/$courseId";
  }
